    ...
    <div style={{ padding: '0px 20px', width: '100%' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'row' }}>
        <div style={{ flex: 1, paddingTop: 10, paddingRight: 5 }}>
          <img src={'https://media.kitsu.io/characters/images/57048/original.jpg?1483096805'} width={'100%'} alt={'img'} />
        </div>
    ...
    <div style={{ padding: '0px 20px', width: '100%' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'row' }}>
        <div style={{ flex: 1, padding: 3 }}>
          <img src={'http://images.goodsmile.info/cgm/images/product/20151030/5303/36153/large/fe952fbafbb73eb31e7d1cbe72a67b32.jpg'} width={'100%'} height={'100%'} alt={'img'} />
        </div>
        <div style={{ flex: 1, padding: 3 }}>
          <img src={'http://images.goodsmile.info/cgm/images/product/20151030/5303/36155/large/72bc2510994236b2922737adb8591f46.jpg'} width={'100%'} height={'100%'} alt={'img'} />
        </div>
        <div style={{ flex: 1, padding: 3 }}>
          <img src={'http://images.goodsmile.info/cgm/images/product/20160623/5762/39735/large/e71790636a80db3b3f4f948c3e8a5478.jpg'} width={'100%'} height={'100%'} alt={'img'} />
        </div>
      </div>
    </div>
  </div>
